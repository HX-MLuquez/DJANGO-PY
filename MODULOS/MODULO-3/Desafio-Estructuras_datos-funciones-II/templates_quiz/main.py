...
opcion = validate(["0","1"], "1")

#todo: 2. Definir el comportamiento de Salir
if opcion == '0':
    print() #* Ver que mensaje Mostrar
    time.sleep(2)
    os.system(op_sys)
    # finalizar programa
...
while correcto and n_pregunta < 3*p_level:
    ...
    if continuar == 'y':
        ...
        # In (nivel) <- string <- "basicas"  ->  arma de manera random una cualquiera de las 3 preguntas 
        ...
        # enunciado[0]  y las alternativas   for e in alternativas: print e[0]
        ...
        verificar(alternativas, eleccion)
            Args:
                alternativas: [LIST] 
                eleccion: STRING  Ejemplo: "b" = "alt_3"   alternativas[1][1]
            Return:
                BOOLEAN
        """
